...
CI | Build 
:------------: | :------------: 
AppVeyor | [![Build status](https://ci.appveyor.com/api/projects/status/github/Dokman/WDBXEditor?branch=master&svg=true)](hhttps://ci.appveyor.com/project/Dokman/wdbxeditor/branch/master) | 
